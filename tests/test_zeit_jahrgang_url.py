...
def test_skips_feed_style_urls():
    assert is_zeit_jahrgang_index_url("https://m.zeit.de/2026/ausgabe/1")
    assert is_zeit_jahrgang_index_url("//www.zeit.de/2026/index")
    assert is_zeit_jahrgang_index_url("zeit.de/2026/foo")
    assert is_zeit_jahrgang_index_url("www.zeit.de/2026/")
...
def test_no_admin_dm_for_zeit_hub_even_with_other_skip_reason():
    article = {"link": "https://m.zeit.de/2026/x", "title": "x"}
